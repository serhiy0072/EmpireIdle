...
/// <summary>
/// Зайнята клітина: хто саме на ній стоїть. Для монстра — його тип і рівень, щоб клієнт малював різних істот.
/// Для кланової споруди — клан, тег (він же Name) і ReadyAt: до цього моменту споруда будується й бонусу не дає.
/// </summary>
